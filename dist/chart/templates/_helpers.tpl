...
*/}}
{{- define "pulsar-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "pulsar-operator.resourceName" -}}
{{- $fullname := include "pulsar-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "pulsar-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
