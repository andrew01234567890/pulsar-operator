...
// Reconcile is a no-op stub; the replay-execution state machine (cookie
// lineage check, spawning the restore Job, tracking its progress, and
// writing status) lands in a follow-up PR.
